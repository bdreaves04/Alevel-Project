...
userSchema.statics.changePassword = async function(username, passwordOld, passwordNew) {
    ...
    if (!validator.isStrongPassword(passwordNew)) throw Error("Password not Strong Enough");
