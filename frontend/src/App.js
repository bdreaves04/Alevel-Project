      ...
      <BrowserRouter>
        ...
        <div className="pages">
          <Routes>
            ...
            <Route
              path="/admin"
              element={adminCheck ? <Admin /> : <Navigate to="/" />}
            />
            <Route
            ...
            <Route
              path="/checkIn"
              element={adminCheck ? <CheckInDesk /> : <Navigate to="/" />}
            />
            <Route
              path="/ringSide"
              element={adminCheck ? <RingSide /> : <Navigate to="/" />}
            />
            <Route
              path="/MatchNo"
              element={adminCheck ? <MatchNoScreen /> : <Navigate to="/" />}
            />
            <Route
              path="/weighIn"
              element={adminCheck ? <WeighIn /> : <Navigate to="/" />}
            />
          </Routes>
        </div>
      </BrowserRouter>
