    ...
    <div className="Home">
      ...
      >
        <Card.Body>
          <Row>
            <Col>
              <Link to={"/ringSide"} style={{ textDecoration: "none" }}>
                <Card style={styleCard} className="align-center">
                  <h1 style={styleText}>Ring Side</h1>
                </Card>
              </Link>
            </Col>
            <Col>
              <Link to={"/matchNo"} style={{ textDecoration: "none" }}>
          ...
          <Row>
            ...
            <Col>
              <Link to={"/weighIn"} style={{ textDecoration: "none" }}>
                <Card style={styleCard}>
